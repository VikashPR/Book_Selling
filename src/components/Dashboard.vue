...
export default {
  data: () => ({
    ...
    styles: [
      { title: "C PROGRAM", count: "1" },
      { title: "JAVA", count: "23" },
      { title: "PYTHON", count: "45" },
      { title: "JAVA SCRIPT", count: "11" },
      { title: "C++", count: "15" },
      { title: "WORDPRESS", count: "32" },
      { title: "LINUX", count: "8" },
      { title: "KALI LINUX", count: "15" },
      { title: "OSX", count: "22" },
    ],
    brands: [
      { title: "C PROGRAM", state: true },
      { title: "JAVA", state: false },
      { title: "PYTHON", state: true },
      { title: "JAVA SCRIPT", state: false },
    ],
    sizes: [
      "35",
      "36",
